        ...
        (acc, package) => {
            try {
                ...
                logger.warn(
                    ...
                    `Othwerise, disable the extension in the root ${ logger.style.file('package.json') } file:`
                    `Append ${ logger.style.command(`"${ package }": false`) } line to the end of the ${ logger.style.misc('extensions') } section.`
                )
